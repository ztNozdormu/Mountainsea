...
// pub const KEY_TYPE: KeyTypeId = KeyTypeId(*b"TOKEN");
// pub const NUM_VEC_LEN: usize = 10;
// /// The type to sign and send transactions.
// pub const UNSIGNED_TXS_PRIORITY: u64 = 100;

// // We are fetching information from the btcusdt public API about TOKEN IFNO .
// pub const HTTP_REMOTE_REQUEST: &str = "http://141.164.45.97:8080/ares/api/getPartyPrice/btcusdt";
...
// impl fmt::Debug for TokenInfo<T::Timestamp> {
